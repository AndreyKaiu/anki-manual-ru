...
На экране колод ваши колоды и подколоды будут отображаться в виде списка. Карточки для [Новых, Изучаемых и Ожидающих повторения (К повторению)](getting-started.md#Состояния-карточки) на этот день также будут здесь показаны.
...
Карточки разделены на [три типа](getting-started.md#card-states): Новые, Изучаемые и Повторяемые.
