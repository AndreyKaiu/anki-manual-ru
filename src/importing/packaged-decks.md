...
Пакеты Anki также могут содержать информацию о планировании, что полезно, если вы хотите переносить колоды между устройствами или профилями. Однако при импорте колоды, которой поделился кто-то другой, обычно нежелательно использовать интервалы карточек или историю повторений.
