...
Чтобы просмотреть список доступных дополнений, выберите **Инструменты > Дополнения**, затем нажмите **Загрузить дополнения**.
...
На большинстве страниц дополнений на AnkiWeb есть кнопка **Contact Author** (Связаться с автором), и многие авторы указывают свой адрес электронной почты в дополнении, поэтому, если вам  нужно связаться с автором, то посмотрите в самое начало файла дополнения «\_\_init\_\_.py».
